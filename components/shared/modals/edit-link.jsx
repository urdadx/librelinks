...
const EditLinkModal = ({ id, title, url }) => {
 ...
 const handleEditLink = useCallback(async () => {
      ...
      await toast.promise(
        axios.patch(`/api/links/${id}`, { newTitle, newUrl }),
        {
 ...
 const handleUrlChange = (event) => {
    ...
    return ( 
        ...
        <div>
            ...
            <Dialog.Content className=" contentShow fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 
                ...
                <div className="relative">
                    <input
                      ...
                      placeholder='URL'
                    />
                    {urlError && <small className="text-red-500 text-sm">Enter a valid url</small>}
                </div>
