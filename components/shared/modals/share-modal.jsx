          ...
          >
            ...
            <div className="mb-4">
              <h3 className="text-sm">
                ...
                <a target="_blank" href={goTo.twitter} className="underline">
                  Twitter
                </a>
                ,{" "}
                <a target="_blank" href={goTo.instagram} className="underline">
                  Instagram
                </a>{" "}
                or{" "}
                <a target="_blank" href={goTo.tiktok} className="underline">
                  Tiktok
                </a>{" "}
                bio 🚀
              </h3>
