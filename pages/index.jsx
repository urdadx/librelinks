...
const Home = () => {
	...
	const fetchStarCount = () => {
		axios.get("https://api.github.com/repos/urdadx/librelinks", {
			headers: {},
		})
			.then((res) => {
	...
	return (
		<>
			...
			<div className="flex items-center justify-center h-auto min-h-[90vh] lg:h-[90vh] xl:h-[90vh] w-full flex-col lg:flex-row xl:flex-row overflow-hidden">
				...
				<div className="w-[340px] lg:w-6/12 xl:w-6/12 h-auto lg:h-full xl:h-full flex items-center justify-center flex-col relative pb-10 lg:pb-0 xl:pb-0">
